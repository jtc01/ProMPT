...
class ObjectBasedEditor(BaseAgent):
    """
    Editor for object-based task prompts - makes minimal changes for improvement
    """
    def __init__(self, model="llama3.2"):
        super().__init__(model)
        
        self.prompt_template = ChatPromptTemplate.from_template("""
        You are an expert prompt editor specializing in tasks that involve specific objects, links, data, or other resources.
        ...
        1. Ensuring the objects or data are properly referenced
        2. Clarifying the analysis or comparison requested
