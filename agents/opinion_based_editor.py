...
class OpinionBasedEditor(BaseAgent):
    """
    Editor for opinion-based task prompts - makes minimal changes for improvement
    """
    def __init__(self, model="llama3.2"):
        super().__init__(model)
        
        self.prompt_template = ChatPromptTemplate.from_template("""
        You are an expert prompt editor specializing in tasks that involve subjective judgments, opinions, or philosophical questions.
        ...
        the feedback while maintaining the core subjective question. Unlike a prompt generator, you should 
        NOT rewrite the entire prompt - make targeted edits to fix specific issues.
        
        Focus particularly on:
        1. Ensuring balanced perspective-taking
        2. Removing any bias toward particular viewpoints
