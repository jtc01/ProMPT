...
class PromptGenerator:
    def __init__(self):
        # Use Ollama for the input manager and reviewer
    ...
    def generate_prompt(self, user_input, max_iterations=3):
        """
        Generate an optimized prompt from user input with reviewer feedback.
...
def main():
    ...
    print("Prompt Generator initialized. Enter 'x' to quit.")
